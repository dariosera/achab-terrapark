...
{
  const HOSTED_VIEWER_ORIGINS = ["https://static.scuolapark.it","null", "http://mozilla.github.io", "https://mozilla.github.io"];
...
};
{
  defaultOptions.defaultUrl = {
    value: atob((new URLSearchParams(window.location.search)).get("url")),
    kind: OptionKind.VIEWER
  };
